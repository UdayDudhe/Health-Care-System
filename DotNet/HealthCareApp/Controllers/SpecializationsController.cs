...
namespace HealthCareApp.Controllers
{
    ...
    public class SpecializationsController : ControllerBase
    {
        ...
        public SpecializationsController(HealthcareContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Specialization>> PostSpecialization(Specialization specialization)
        {
            ...
            return CreatedAtAction("GetSpecialization", new { id = specialization.Spid }, specialization);
        }
        ...
        {
            return _context.Specializations.Any(e => e.Spid == id);
        }
    }
}
